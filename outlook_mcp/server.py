...
# ---------------------------------------------------------------------------
# Credentials: environment variables in stdio mode, request headers in HTTP mode
# ---------------------------------------------------------------------------
...
def main(argv: Optional[List[str]] = None):
    ...
    if _config.is_http:
        ...
        print(
            f"Starting Outlook MCP server on {_config.http_url} "
            f"(bind {_config.bind_host}:{_config.bind_port}, config: {_config.source})",
            file=sys.stderr,
        )
